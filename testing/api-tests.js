/**
 * API Testing Suite for Promptomatik
 * 
...
const TEST_EMAIL = process.env.TEST_EMAIL || 'test@promptomatik.co';
...
class APITester {
  ...
  generateTestEmail() {
    ...
    return `test-${timestamp}@promptomatik.co`;
  }
...
async function runAllTests() {
  console.log('🚀 Starting API Test Suite for Promptomatik\n');
