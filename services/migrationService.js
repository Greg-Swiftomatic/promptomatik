/**
 * localStorage Migration Service for Promptomatik
 * 
...
// Constants
const LOCALSTORAGE_KEY = 'promptomatik-prompts';
const MIGRATION_STATUS_KEY = 'promptomatik-migration-status';
const BACKUP_KEY = 'promptomatik-prompts-backup';
